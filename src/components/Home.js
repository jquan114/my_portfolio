...
import img from '../images/profile6.png';
  ...
  return (
    <Container>
      <Introduction>
        ...
        <div className="short">
          A Full Stack Software Developer and Entrepreneur that enjoys Web
        ...
        <Social>
          <div className="iconcontainer">
            <a
              className="same"
              href="https://github.com/jquan114"
              target="_blank"
          ...
          <div className="iconcontainer">
            <a
              className="same"
              href="https://www.linkedin.com/in/jquancollins/"
              target="_blank"
              rel="noopener noreferrer"
              title="Look through my Github profile"
            >
